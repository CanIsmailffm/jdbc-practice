...
import static io.restassured.module.jsv.JsonSchemaValidator.*; // import
...
public class  JsonSchemaValidation {
    ...
    public void jsonSchemaValidationForSpartan(){
        ...
        given().accept(ContentType.JSON)
                ...
                .statusCode(200).body(matchesJsonSchemaInClasspath("SingleSpartanSchema.json")); // import jsv
